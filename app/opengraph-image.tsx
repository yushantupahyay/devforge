      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: "60px 72px", height: "100%", position: "relative", zIndex: 10 }}>
              ...
              <div
                ...
                style={{
                  ...
                  border: i % 3 === 0
                    ...
                    : "1px solid rgba(219,39,119,0.35)",
                  color: i % 3 === 0 ? "#c4b5fd" : i % 3 === 1 ? "#67e8f9" : "#f9a8d4",
          ...
          <div style={{ marginTop: "auto", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.45)", fontSize: 18, fontWeight: 600, letterSpacing: 0.5 }}>
              ineedtools.in
            </span>
          </div>
